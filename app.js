...
async function main(){
  await mongoose.connect('mongodb+srv://admin-aman:Test123@cluster0.goer0w1.mongodb.net/todolistDB?retryWrites=true&w=majority');
  ...
  app.post("/", function(req, res) {
    // Handle POST requests for adding new items here
